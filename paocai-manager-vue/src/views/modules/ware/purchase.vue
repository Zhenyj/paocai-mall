  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('ware:purchase:save')"
                   type="primary"
                   @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('ware:purchase:delete')"
                   type="danger"
                   @click="deleteHandle()"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="assigneeId"
                       header-align="center"
                       align="center"
                       label="采购人id"></el-table-column>
      <el-table-column prop="assigneeName"
                       header-align="center"
                       align="center"
      ...
      <el-table-column prop="status"
        ...
        <template slot-scope="scope">
          ...
          <el-tag type="warning"
                  v-if="scope.row.status == 2">已领取</el-tag>
          <el-tag type="success"
                  v-if="scope.row.status == 3">已完成</el-tag>
          <el-tag type="danger"
                  v-if="scope.row.status == 4">有异常</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog title="分配采购人员"
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="assignUser">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
