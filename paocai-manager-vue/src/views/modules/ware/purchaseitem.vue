  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item label="状态">
        <el-select style="width:120px;"
          ...
          <el-option label="已分配"
                     :value="1"></el-option>
          <el-option label="正在采购"
                     :value="2"></el-option>
          <el-option label="已完成"
                     :value="3"></el-option>
          <el-option label="采购失败"
                     :value="4"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('ware:purchasedetail:save')"
                   type="primary"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="status"
        ...
        <template slot-scope="scope">
          ...
          <el-tag type="info"
                  v-if="scope.row.status==1">已分配</el-tag>
          <el-tag type="wanring"
                  v-if="scope.row.status==2">正在采购</el-tag>
          <el-tag type="success"
                  v-if="scope.row.status==3">已完成</el-tag>
          <el-tag type="danger"
                  v-if="scope.row.status==4">采购失败</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog title="合并到整单"
      ...
      <el-select v-model="purchaseId"
                 ...
                 clearable
                 filterable>
        <el-option v-for="item in purchasetableData"
                   :key="item.id"
                   :label="item.id"
                   :value="item.id">
