  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:skufullreduction:save')"
                   type="primary"
                   @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('coupon:skufullreduction:delete')"
                   type="danger"
                   @click="deleteHandle()"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="fullPrice"
                       header-align="center"
                       align="center"
                       label="满多少">
      </el-table-column>
      <el-table-column prop="reducePrice"
                       header-align="center"
                       align="center"
                       label="减多少">
      </el-table-column>
