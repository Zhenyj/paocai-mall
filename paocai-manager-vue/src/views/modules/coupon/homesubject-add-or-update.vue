<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dataForm"
             ...
             label-width="120px">
      <el-form-item label="专题名字"
                    prop="name">
        <el-input v-model="dataForm.name"
                  placeholder="专题名字"></el-input>
      </el-form-item>
      <el-form-item label="专题标题"
                    prop="title">
        <el-input v-model="dataForm.title"
                  placeholder="专题标题"></el-input>
      </el-form-item>
      <el-form-item label="专题副标题"
                    prop="subTitle">
        <el-input v-model="dataForm.subTitle"
                  placeholder="专题副标题"></el-input>
      </el-form-item>
      ...
      <el-form-item label="详情连接"
                    prop="url">
        <el-input v-model="dataForm.url"
                  placeholder="详情连接"></el-input>
      </el-form-item>
