  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:coupon:save')"
                   type="primary"
                   @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('coupon:coupon:delete')"
                   type="danger"
                   @click="deleteHandle()"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="couponType"
                       header-align="center"
                       align="center"
                       label="优惠卷类型">
        <template slot-scope="scope">
          ...
          <el-tag type="info"
                  v-if="scope.row.couponType==1">会员赠券</el-tag>
          <el-tag type="success"
                  v-if="scope.row.couponType==2">购物赠券</el-tag>
          <el-tag type="warning"
                  v-if="scope.row.couponType==3">注册赠券</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="couponImg"
                       header-align="center"
                       align="center"
                       label="优惠券图片"></el-table-column>
      <el-table-column prop="couponName"
                       header-align="center"
                       align="center"
                       label="优惠卷名字"></el-table-column>
      ...
      <el-table-column prop="perLimit"
                       header-align="center"
                       align="center"
                       label="每人限领张数"></el-table-column>
      <el-table-column prop="minPoint"
                       header-align="center"
                       align="center"
      ...
      <el-table-column prop="useType"
        ...
        <template slot-scope="scope">
          ...
          <el-tag type="info"
                  v-if="scope.row.useType==1">指定分类</el-tag>
          <el-tag type="success"
                  v-if="scope.row.useType==2">指定商品</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="publishCount"
                       header-align="center"
                       align="center"
                       label="发行数量"></el-table-column>
      ...
      <el-table-column prop="receiveCount"
                       header-align="center"
                       align="center"
                       label="领取数量"></el-table-column>
      <el-table-column label="可以领取的日期">
        <el-table-column prop="enableStartTime"
                         header-align="center"
                         align="center"
                         label="开始日期"></el-table-column>
        <el-table-column prop="enableEndTime"
                         header-align="center"
                         align="center"
      ...
      <el-table-column prop="code"
                       header-align="center"
                       align="center"
                       label="优惠码"></el-table-column>
      <el-table-column prop="memberLevel"
                       header-align="center"
                       align="center"
                       label="领取所需等级">
        <template slot-scope="scope">
          ...
          <el-tag type="info"
                  v-else>{{getLevel(scope.row.memberLevel)}}</el-tag>
        </template>
      </el-table-column>
