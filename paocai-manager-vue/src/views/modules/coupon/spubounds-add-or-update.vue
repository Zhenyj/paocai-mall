<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dataForm"
      ...
      <el-form-item label="成长积分"
                    prop="growBounds">
        <el-input v-model="dataForm.growBounds"
                  placeholder="成长积分"></el-input>
      </el-form-item>
      <el-form-item label="购物积分"
                    prop="buyBounds">
        <el-input v-model="dataForm.buyBounds"
                  placeholder="购物积分"></el-input>
      </el-form-item>
      <!-- [1111（四个状态位，从右到左）;0 - 无优惠，成长积分是否赠送;1 - 无优惠，购物积分是否赠送;2 - 有优惠，成长积分是否赠送;3 - 有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】] -->
      <el-form-item label="优惠生效情况"
                    prop="work">
        <el-input v-model="dataForm.work"
                  placeholder="优惠生效情况"></el-input>
      </el-form-item>
    </el-form>
    <span slot="footer"
          class="dialog-footer">
