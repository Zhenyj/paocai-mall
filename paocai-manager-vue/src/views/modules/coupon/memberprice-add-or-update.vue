  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dataForm"
      ...
      <el-form-item label="会员等级id"
                    prop="memberLevelId">
        <el-input v-model="dataForm.memberLevelId"
                  placeholder="会员等级id"></el-input>
      </el-form-item>
      <el-form-item label="会员等级名"
                    prop="memberLevelName">
        <el-input v-model="dataForm.memberLevelName"
                  placeholder="会员等级名"></el-input>
      </el-form-item>
      <el-form-item label="会员对应价格"
                    prop="memberPrice">
        <el-input v-model="dataForm.memberPrice"
                  placeholder="会员对应价格"></el-input>
      </el-form-item>
      <el-form-item label="可否叠加其他优惠"
                    prop="addOther">
        <el-switch v-model="dataForm.addOther"
                   :active-value="1"
                   inactive-value="0"
                   active-text="可叠加"
                   inactive-text="不可叠加"></el-switch>
      </el-form-item>
    </el-form>
    <span slot="footer"
          class="dialog-footer">
