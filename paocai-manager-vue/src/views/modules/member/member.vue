  ...
  <div class="mod-config">
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="sign"
                       header-align="center"
                       align="center"
                       label="个性签名"></el-table-column>
      <el-table-column prop="sourceType"
                       header-align="center"
                       align="center"
                       label="用户来源"></el-table-column>
      ...
      <el-table-column fixed="right"
        ...
        <template slot-scope="scope">
          <el-button type="text"
                     size="small">送券</el-button>
          <el-button type="text"
                     size="small">查订单</el-button>
        </template>
      </el-table-column>
    </el-table>
