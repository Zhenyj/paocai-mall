    ...
    <el-form :model="dataForm"
      ...
      <el-form-item label="order_id"
        ...
        <el-input v-model="dataForm.orderId"
                  placeholder="order_id"></el-input>
      </el-form-item>
      <el-form-item label="退货商品id"
                    prop="skuId">
        <el-input v-model="dataForm.skuId"
                  placeholder="退货商品id"></el-input>
      </el-form-item>
      ...
      <el-form-item label="会员用户名"
        ...
        <el-input v-model="dataForm.memberUsername"
                  placeholder="会员用户名"></el-input>
      </el-form-item>
      <el-form-item label="退款金额"
                    prop="returnAmount">
        <el-input v-model="dataForm.returnAmount"
                  placeholder="退款金额"></el-input>
      </el-form-item>
      <el-form-item label="退货人姓名"
                    prop="returnName">
        <el-input v-model="dataForm.returnName"
                  placeholder="退货人姓名"></el-input>
      </el-form-item>
      <el-form-item label="退货人电话"
                    prop="returnPhone">
        <el-input v-model="dataForm.returnPhone"
                  placeholder="退货人电话"></el-input>
      </el-form-item>
      <el-form-item label="申请状态[0->待处理；1->退货中；2->已完成；3->已拒绝]"
                    prop="status">
        <el-input v-model="dataForm.status"
                  placeholder="申请状态[0->待处理；1->退货中；2->已完成；3->已拒绝]"></el-input>
      </el-form-item>
      <el-form-item label="处理时间"
                    prop="handleTime">
        <el-input v-model="dataForm.handleTime"
                  placeholder="处理时间"></el-input>
      </el-form-item>
      <el-form-item label="商品图片"
                    prop="skuImg">
        <el-input v-model="dataForm.skuImg"
                  placeholder="商品图片"></el-input>
      </el-form-item>
      ...
      <el-form-item label="商品品牌"
                    prop="skuBrand">
        <el-input v-model="dataForm.skuBrand"
                  placeholder="商品品牌"></el-input>
      </el-form-item>
      <el-form-item label="商品销售属性(JSON)"
                    prop="skuAttrsVals">
        <el-input v-model="dataForm.skuAttrsVals"
                  placeholder="商品销售属性(JSON)"></el-input>
      </el-form-item>
      <el-form-item label="退货数量"
                    prop="skuCount">
        <el-input v-model="dataForm.skuCount"
                  placeholder="退货数量"></el-input>
      </el-form-item>
      <el-form-item label="商品单价"
                    prop="skuPrice">
        <el-input v-model="dataForm.skuPrice"
                  placeholder="商品单价"></el-input>
      </el-form-item>
      <el-form-item label="商品实际支付单价"
                    prop="skuRealPrice">
        <el-input v-model="dataForm.skuRealPrice"
                  placeholder="商品实际支付单价"></el-input>
      </el-form-item>
      ...
      <el-form-item label="描述"
                    prop="description述">
        <el-input v-model="dataForm.description述"
                  placeholder="描述"></el-input>
      </el-form-item>
      <el-form-item label="凭证图片，以逗号隔开"
                    prop="descPics">
        <el-input v-model="dataForm.descPics"
                  placeholder="凭证图片，以逗号隔开"></el-input>
      </el-form-item>
      <el-form-item label="处理备注"
                    prop="handleNote">
        <el-input v-model="dataForm.handleNote"
                  placeholder="处理备注"></el-input>
      </el-form-item>
      <el-form-item label="处理人员"
                    prop="handleMan">
        <el-input v-model="dataForm.handleMan"
                  placeholder="处理人员"></el-input>
      </el-form-item>
      <el-form-item label="收货人"
                    prop="receiveMan">
        <el-input v-model="dataForm.receiveMan"
                  placeholder="收货人"></el-input>
      </el-form-item>
      <el-form-item label="收货时间"
                    prop="receiveTime">
        <el-input v-model="dataForm.receiveTime"
                  placeholder="收货时间"></el-input>
      </el-form-item>
      <el-form-item label="收货备注"
                    prop="receiveNote">
        <el-input v-model="dataForm.receiveNote"
                  placeholder="收货备注"></el-input>
      </el-form-item>
      <el-form-item label="收货电话"
                    prop="receivePhone">
        <el-input v-model="dataForm.receivePhone"
                  placeholder="收货电话"></el-input>
      </el-form-item>
      <el-form-item label="公司收货地址"
                    prop="companyAddress">
        <el-input v-model="dataForm.companyAddress"
                  placeholder="公司收货地址"></el-input>
      </el-form-item>
    </el-form>
    <span slot="footer"
          class="dialog-footer">
