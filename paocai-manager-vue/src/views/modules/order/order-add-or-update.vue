<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dataForm"
             ...
             label-width="120px">
      <el-form-item label="member_id"
                    prop="memberId">
        <el-input v-model="dataForm.memberId"
                  placeholder="member_id"></el-input>
      </el-form-item>
      ...
      <el-form-item label="使用的优惠券"
        ...
        <el-input v-model="dataForm.couponId"
                  placeholder="使用的优惠券"></el-input>
      </el-form-item>
      <el-form-item label="create_time"
                    prop="createTime">
        <el-input v-model="dataForm.createTime"
                  placeholder="create_time"></el-input>
      </el-form-item>
      <el-form-item label="用户名"
                    prop="memberUsername">
        <el-input v-model="dataForm.memberUsername"
                  placeholder="用户名"></el-input>
      </el-form-item>
      <el-form-item label="订单总额"
                    prop="totalAmount">
        <el-input v-model="dataForm.totalAmount"
                  placeholder="订单总额"></el-input>
      </el-form-item>
      <el-form-item label="应付总额"
                    prop="payAmount">
        <el-input v-model="dataForm.payAmount"
                  placeholder="应付总额"></el-input>
      </el-form-item>
      <el-form-item label="运费金额"
                    prop="freightAmount">
        <el-input v-model="dataForm.freightAmount"
                  placeholder="运费金额"></el-input>
      </el-form-item>
      <el-form-item label="促销优化金额（促销价、满减、阶梯价）"
                    prop="promotionAmount">
        <el-input v-model="dataForm.promotionAmount"
                  placeholder="促销优化金额（促销价、满减、阶梯价）"></el-input>
      </el-form-item>
      <el-form-item label="积分抵扣金额"
                    prop="integrationAmount">
        <el-input v-model="dataForm.integrationAmount"
                  placeholder="积分抵扣金额"></el-input>
      </el-form-item>
      <el-form-item label="优惠券抵扣金额"
                    prop="couponAmount">
        <el-input v-model="dataForm.couponAmount"
                  placeholder="优惠券抵扣金额"></el-input>
      </el-form-item>
      <el-form-item label="后台调整订单使用的折扣金额"
                    prop="discountAmount">
        <el-input v-model="dataForm.discountAmount"
                  placeholder="后台调整订单使用的折扣金额"></el-input>
      </el-form-item>
      <el-form-item label="支付方式【1->支付宝；2->微信；3->银联； 4->货到付款；】"
                    prop="payType">
        <el-input v-model="dataForm.payType"
                  placeholder="支付方式【1->支付宝；2->微信；3->银联； 4->货到付款；】"></el-input>
      </el-form-item>
      <el-form-item label="订单来源[0->PC订单；1->app订单]"
                    prop="sourceType">
        <el-input v-model="dataForm.sourceType"
                  placeholder="订单来源[0->PC订单；1->app订单]"></el-input>
      </el-form-item>
      ...
      <el-form-item label="物流公司(配送方式)"
                    prop="deliveryCompany">
        <el-input v-model="dataForm.deliveryCompany"
                  placeholder="物流公司(配送方式)"></el-input>
      </el-form-item>
      <el-form-item label="物流单号"
                    prop="deliverySn">
        <el-input v-model="dataForm.deliverySn"
                  placeholder="物流单号"></el-input>
      </el-form-item>
      <el-form-item label="自动确认时间（天）"
                    prop="autoConfirmDay">
        <el-input v-model="dataForm.autoConfirmDay"
                  placeholder="自动确认时间（天）"></el-input>
      </el-form-item>
      <el-form-item label="可以获得的积分"
                    prop="integration">
        <el-input v-model="dataForm.integration"
                  placeholder="可以获得的积分"></el-input>
      </el-form-item>
      <el-form-item label="可以获得的成长值"
                    prop="growth">
        <el-input v-model="dataForm.growth"
                  placeholder="可以获得的成长值"></el-input>
      </el-form-item>
      <el-form-item label="发票类型[0->不开发票；1->电子发票；2->纸质发票]"
                    prop="billType">
        <el-input v-model="dataForm.billType"
                  placeholder="发票类型[0->不开发票；1->电子发票；2->纸质发票]"></el-input>
      </el-form-item>
      <el-form-item label="发票抬头"
                    prop="billHeader">
        <el-input v-model="dataForm.billHeader"
                  placeholder="发票抬头"></el-input>
      </el-form-item>
      <el-form-item label="发票内容"
                    prop="billContent">
        <el-input v-model="dataForm.billContent"
                  placeholder="发票内容"></el-input>
      </el-form-item>
      <el-form-item label="收票人电话"
                    prop="billReceiverPhone">
        <el-input v-model="dataForm.billReceiverPhone"
                  placeholder="收票人电话"></el-input>
      </el-form-item>
      <el-form-item label="收票人邮箱"
                    prop="billReceiverEmail">
        <el-input v-model="dataForm.billReceiverEmail"
                  placeholder="收票人邮箱"></el-input>
      </el-form-item>
      ...
      <el-form-item label="收货人电话"
                    prop="receiverPhone">
        <el-input v-model="dataForm.receiverPhone"
                  placeholder="收货人电话"></el-input>
      </el-form-item>
      <el-form-item label="收货人邮编"
                    prop="receiverPostCode">
        <el-input v-model="dataForm.receiverPostCode"
                  placeholder="收货人邮编"></el-input>
      </el-form-item>
      <el-form-item label="省份/直辖市"
                    prop="receiverProvince">
        <el-input v-model="dataForm.receiverProvince"
                  placeholder="省份/直辖市"></el-input>
      </el-form-item>
      <el-form-item label="城市"
                    prop="receiverCity">
        <el-input v-model="dataForm.receiverCity"
                  placeholder="城市"></el-input>
      </el-form-item>
      <el-form-item label="区"
                    prop="receiverRegion">
        <el-input v-model="dataForm.receiverRegion"
                  placeholder="区"></el-input>
      </el-form-item>
      <el-form-item label="详细地址"
                    prop="receiverDetailAddress">
        <el-input v-model="dataForm.receiverDetailAddress"
                  placeholder="详细地址"></el-input>
      </el-form-item>
      <el-form-item label="订单备注"
                    prop="note">
        <el-input v-model="dataForm.note"
                  placeholder="订单备注"></el-input>
      </el-form-item>
      <el-form-item label="确认收货状态[0->未确认；1->已确认]"
                    prop="confirmStatus">
        <el-input v-model="dataForm.confirmStatus"
                  placeholder="确认收货状态[0->未确认；1->已确认]"></el-input>
      </el-form-item>
      <el-form-item label="删除状态【0->未删除；1->已删除】"
                    prop="deleteStatus">
        <el-input v-model="dataForm.deleteStatus"
                  placeholder="删除状态【0->未删除；1->已删除】"></el-input>
      </el-form-item>
      <el-form-item label="下单时使用的积分"
                    prop="useIntegration">
        <el-input v-model="dataForm.useIntegration"
                  placeholder="下单时使用的积分"></el-input>
      </el-form-item>
      <el-form-item label="支付时间"
                    prop="paymentTime">
        <el-input v-model="dataForm.paymentTime"
                  placeholder="支付时间"></el-input>
      </el-form-item>
      <el-form-item label="发货时间"
                    prop="deliveryTime">
        <el-input v-model="dataForm.deliveryTime"
                  placeholder="发货时间"></el-input>
      </el-form-item>
      <el-form-item label="确认收货时间"
                    prop="receiveTime">
        <el-input v-model="dataForm.receiveTime"
                  placeholder="确认收货时间"></el-input>
      </el-form-item>
      <el-form-item label="评价时间"
                    prop="commentTime">
        <el-input v-model="dataForm.commentTime"
                  placeholder="评价时间"></el-input>
      </el-form-item>
      <el-form-item label="修改时间"
                    prop="modifyTime">
        <el-input v-model="dataForm.modifyTime"
                  placeholder="修改时间"></el-input>
      </el-form-item>
    </el-form>
    <span slot="footer"
          class="dialog-footer">
