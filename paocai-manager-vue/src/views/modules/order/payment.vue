  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('order:paymentinfo:save')"
                   type="primary"
                   @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('order:paymentinfo:delete')"
                   type="danger"
                   @click="deleteHandle()"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="alipayTradeNo"
                       header-align="center"
                       align="center"
                       label="支付宝交易流水号">
      </el-table-column>
      ...
      <el-table-column prop="callbackContent"
                       header-align="center"
                       align="center"
                       label="回调内容">
      </el-table-column>
      <el-table-column prop="callbackTime"
                       header-align="center"
                       align="center"
                       label="回调时间">
      </el-table-column>
