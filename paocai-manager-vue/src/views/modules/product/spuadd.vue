          ...
          <el-form ref="spuBaseForm"
            ...
            <el-form-item>
              <el-button type="success"
                         @click="collectSpuBaseInfo">下一步：设置基本参数
              </el-button>
            </el-form-item>
          </el-form>
        </el-card>
      ...
      <el-col :span="24"
        ...
        <el-card class="box-card"
          ...
          <div style="margin:auto">
            ...
            <el-button type="success"
                       @click="generateSaleAttrs">下一步：设置销售属性
            </el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="24"
        ...
        <el-card class="box-card"
          ...
          <el-card class="box-card">
              ...
              <el-form ref="saleform"
                ...
                <el-form-item :label="attr.attrName"
                  ...
                  <el-checkbox-group v-model="dataResp.tempSaleAttrs[aidx].attrValues">
                    <el-checkbox v-if="dataResp.saleAttrs[aidx].valueSelect != ''"
                                 :label="val"
            ...
            <el-button type="success"
                       @click="generateSkus">下一步：设置SKU信息
            </el-button>
          </el-card>
        </el-card>
      </el-col>
