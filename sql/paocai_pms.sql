/*
 ...
 Source Server         : paocai
 Source Server Type    : MySQL
 Source Server Version : 50737
 Source Host           : 192.168.136.12:3306
 Source Schema         : paocai_pms

 Target Server Type    : MySQL
 Target Server Version : 50737
 File Encoding         : 65001

 Date: 27/05/2022 13:19:31
*/
...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(4) NULL DEFAULT 0 COMMENT '值类型【0：单值；1：多值】',
  PRIMARY KEY (`attr_id`) USING BTREE,
  INDEX `idx_catalog_id`(`catelog_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1293 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1294 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_attr_group`  (
  ...
  INDEX `idx_catelog_id`(`catelog_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1284 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  INDEX `idx_catelog_id`(`catelog_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  INDEX `idx_attr_id`(`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for pms_promote
-- ----------------------------
DROP TABLE IF EXISTS `pms_promote`;
CREATE TABLE `pms_promote`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '推广id',
  `promote_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '推广名',
  ...
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '推广类型[0-大图显示，1-小图显示]',
  `promote_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '点击跳转的链接',
  `show_status` tinyint(4) NULL DEFAULT NULL COMMENT '是否显示[0-不显示，1显示]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '首页推广' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1702 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_sku_info`  (
  ...
  INDEX `idx_brand_id`(`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1702 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  INDEX `idx_sku_id`(`sku_id`) USING BTREE,
  INDEX `idx_attr_id`(`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1738 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_spu_id`(`spu_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3337 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_spu_info`  (
  ...
  INDEX `idx_catalog_id`(`catalog_id`) USING BTREE,
  INDEX `idx_brand_id`(`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1672 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;
