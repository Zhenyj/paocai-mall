  ...
  <log-reg :title="title">
    <div class="login-slot">
      ...
      <div class="login-form-wrap" v-show="loginType === 0">
        <el-form class="login-form" status-icon :model="loginForm" ref="loginForm" :rules="rules">
          <el-form-item prop="loginAccount">
            <div class="fm-field">
              <div class="fm-field-input">
                <div class="fm-label-icon"><i class="iconfont icon-member" title="用户名"></i></div>
                <el-input v-model="loginForm.loginAccount" placeholder="会员名/邮箱/手机号" size="large" style="width:100%;">
                </el-input>
              </div>
            </div>
          </el-form-item>
          <el-form-item prop="password">
            <div class="fm-field">
              ...
              <div class="fm-field-input">
                <el-input v-model="loginForm.password" placeholder="请输入登录密码" size="large" type="password"></el-input>
              </div>
            </div>
          </el-form-item>
        </el-form>
      ...
      <div class="login-form-wrap" v-show="loginType === 1">
        <el-form class="login-form" status-icon :model="mobileLoginForm" ref="mobileLoginForm" :rules="mobileRules">
          <el-form-item prop="mobile">
            <div class="fm-field">
              <div class="fm-label-icon"><i class="iconfont icon-member" title="手机号"></i></div>
              <div class="fm-field-input">
                <el-input v-model="mobileLoginForm.mobile" placeholder="请输入手机号" size="large" style="width:100%;"
          ...
          <el-form-item prop="code">
            <div class="fm-field">
              ...
              <div class="fm-field-input">
                <el-input v-model="mobileLoginForm.code" placeholder="请输入验证码" size="large" :maxlength="6">
                  <template #suffix>
