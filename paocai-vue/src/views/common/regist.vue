  ...
  <log-reg :title="title">
    <div class="regist" v-if="!registStatus">
      <div class="regist-form-wrap">
        <el-form class="regist-form" status-icon :model="registForm" ref="registForm" :rules="rules" label-position="top">
          <el-form-item label="用户名" prop="username">
            <div class="fm-field">
              <div class="fm-field-input">
                <el-input v-model="registForm.username" placeholder="您的用户名或登录名" size="large" maxlength="11"
          ...
          <el-form-item label="设置密码" prop="password">
            <div class="fm-field">
              <div class="fm-field-input">
                <el-input v-model="registForm.password" placeholder="建议两种或以上的字符组合" size="large" type="password"
          ...
          <el-form-item label="确认密码" prop="confirmPassword">
            <div class="fm-field">
              <div class="fm-field-input">
                <el-input v-model="registForm.confirmPassword" placeholder="请再次输入密码" size="large" type="text"
                  show-password></el-input>
              </div>
            </div>
          </el-form-item>
          <el-form-item label="手机号" prop="phone">
            <div class="fm-field">
              <div class="fm-field-input">
                <el-input v-model="registForm.phone" placeholder="请输入手机号" size="large" type="text">
                </el-input>
              </div>
            </div>
          </el-form-item>
          <el-form-item label="邮箱" prop="email">
            <div class="fm-field">
              <div class="fm-field-input">
                <el-input v-model="registForm.email" placeholder="请输入邮箱" size="large" type="text">
                </el-input>
              </div>
            </div>
          </el-form-item>
        </el-form>
        <button class="submit" @click="regist('registForm')">注册</button>
    ...
    methods: {
      ...
      async doRegist () {
        ...
        if (res.code === 200) {
          ...
          this.$message(res.msg ? res.msg : '注册失败');
        }
      }
    }
  };
